...
namespace Ciciovan_Bogdan_Ionut_Lab4
{
    ...
    {
        public const string RetrainFilePath =  @"D:\Facultate_Materiale\BAMI\Anul 1\SEM 1\Dezvoltarea de sisteme de Big Data\18 Decembrie 2025 (Online sincron)\fare-train-data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"vendor_id", @"vendor_id"),new InputOutputColumnPair(@"payment_type", @"payment_type")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.LightGbm(new LightGbmRegressionTrainer.Options(){NumberOfLeaves=2863,NumberOfIterations=4,MinimumExampleCountPerLeaf=26,LearningRate=0.9999997766729865,LabelColumnName=@"fare_amount",FeatureColumnName=@"Features",Booster=new GradientBooster.Options(){SubsampleFraction=0.9999997766729865,FeatureFraction=0.9963522339927379,L1Regularization=2E-10,L2Regularization=0.17283214606349284},MaximumBinCountPerFeature=326}));
