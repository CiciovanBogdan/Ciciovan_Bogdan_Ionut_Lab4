...
namespace Ciciovan_Bogdan_Ionut_Lab4.Controllers
{
    public class BatchPredictionController : Controller
    {
        ...
        public IActionResult Batch(BatchPredictionViewModel model)
        {
            ...
            var dataView = mlContext.Data.LoadFromTextFile<PricePredictionModel.ModelInput>(
            path: tempFilePath,
            hasHeader: true,
            separatorChar: ',');
            ...
            var predictions = mlContext.Data.CreateEnumerable<PricePredictionModel.ModelOutput>(
            predictionsDataView,
